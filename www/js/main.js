...
var ajax = {  
    parseJSONP:function(result){  
        ...
        $.each(result.results, function(i, row) {
            ...
            $('#movie-list').append('<li><a href="" data-id="' + row.id + '"><img src="http://d3gtl9l2a4fn1j.cloudfront.net/t/p/w185'+row.poster_path+'"/><h3>' + row.title + '</h3><p>' + row.vote_average + '/10</p><span class="ui-li-count">' + row.vote_average + '</span></a></li>');
        });
